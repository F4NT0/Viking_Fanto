...
root = Tk()
menu = Menu(root, background="black", fg="white")
root.geometry("1000x1000+30+30")
root.resizable(0,0)
root.config(menu=menu)

programmenu = Menu(menu, background="black", fg="white")
...
machinemenu = Menu(menu, background="black", fg="white")
...
Label(topframe,background="black",fg="white", text="Program:", width=46, font=('Courier', 11, 'bold'), anchor=W).pack(side=LEFT)
...
Button(middleframe, text='Resetar', width=14, command=reset, background="black", fg="white").pack()
Button(middleframe, text='Parar', width=14, command=stop, background="black", fg="white").pack()
Button(middleframe, text='Iniciar', width=14, command=run, background="black", fg="white").pack()
